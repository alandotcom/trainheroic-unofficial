...
never included. Response diagnostics retain machine-readable error codes and status fields while
redacting all free-form strings. Paths, query strings, credentials, session tokens, and login
