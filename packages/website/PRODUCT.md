...
Capable, direct, quietly opinionated. Expert confidence without gym-bro energy or SaaS cheerleading. Feels like documentation written by someone who ships the code, not a marketing team.

## Anti-references

- Purple gradient heroes and glassmorphism cards
- Dark mode + amber/gold accent (generic dev-tool slop)
- Identical icon-card grids repeated three times
...
WCAG 2.1 AA contrast on body text. Visible focus rings. Respect `prefers-reduced-motion`. Code blocks scroll horizontally; no information conveyed by color alone.
